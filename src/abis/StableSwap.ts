...
import {ABI_JSON} from './StableSwap.abi'
...
export const functions = {
    ...
    calculateRemoveLiquidityOneToken: new Func<[amount: bigint, index: number], {amount: bigint, index: number}, bigint>(
        abi, '0x342a87a1'
    ),
    calculateSwap: new Func<[inIndex: number, outIndex: number, inAmount: bigint], {inIndex: number, outIndex: number, inAmount: bigint}, bigint>(
        abi, '0xa95b089f'
    ),
    ...
    swap: new Func<[fromIndex: number, toIndex: number, inAmount: bigint, minOutAmount: bigint, deadline: bigint], {fromIndex: number, toIndex: number, inAmount: bigint, minOutAmount: bigint, deadline: bigint}, bigint>(
        abi, '0x91695586'
    ),
...
export class Contract extends ContractBase {
    ...
    calculateRemoveLiquidityOneToken(amount: bigint, index: number): Promise<bigint> {
        return this.eth_call(functions.calculateRemoveLiquidityOneToken, [amount, index])
    }

    calculateSwap(inIndex: number, outIndex: number, inAmount: bigint): Promise<bigint> {
        return this.eth_call(functions.calculateSwap, [inIndex, outIndex, inAmount])
    }
