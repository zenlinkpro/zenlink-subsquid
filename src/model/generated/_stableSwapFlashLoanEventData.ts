...
export class StableSwapFlashLoanEventData {
    ...
    constructor(props?: Partial<Omit<StableSwapFlashLoanEventData, 'toJSON'>>, json?: any) {
        ...
        if (json != null) {
            ...
            this._amountsOut = marshal.fromList(json.amountsOut, val => marshal.string.fromJSON(val))
        }
    }
